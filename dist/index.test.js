...
describe('WebExtCookies', () => {
    ...
    it('should call get with correct details', async () => {
        ...
        chrome.cookies.get.mockImplementation((d, cb) => cb(mockCookie));
    ...
    it('should return null if get returns no cookie', async () => {
        chrome.cookies.get.mockImplementation((d, cb) => cb(null));
    ...
    it('should call getAll with correct details', async () => {
        ...
        chrome.cookies.getAll.mockImplementation((d, cb) => cb(mockCookies));
    ...
    it('should return empty array if getAll returns null', async () => {
        chrome.cookies.getAll.mockImplementation((d, cb) => cb(null));
    ...
    it('should call set with correct details', async () => {
        ...
        const mockCookie = { name: 'test', value: 'value' };
        chrome.cookies.set.mockImplementation((d, cb) => cb(mockCookie));
    ...
    it('should call remove with correct details', async () => {
        ...
        chrome.cookies.remove.mockImplementation((d, cb) => cb(removedDetails));
    ...
    it('should call getAllCookieStores', async () => {
        ...
        chrome.cookies.getAllCookieStores.mockImplementation((cb) => cb(mockStores));
    ...
    it('should handle set failure by returning null', async () => {
        chrome.cookies.set.mockImplementation((d, cb) => cb(null));
